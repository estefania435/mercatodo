                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea readonly class="form-control" name="specifications"
                                                  id="specifications" rows="3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea readonly class="form-control" name="data_of_interest"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-outline-success "
                                           href="{{ route('admin.product.edit',$product->slug) }}">Edit</a>
                                    </div>
                                    <!-- /.form-group -->
