...
class ReportSaleTest extends TestCase
{
    use RefreshDatabase;
     ...
     * @return void
     */
    public function aUserNotAuthenticatedCanGenerateSaleReport(): void
    {
        ...
        Excel::fake();
        $this->get(route('report.sales', ['extension' => 'xlsx']))
     ...
     * @return void
     */
    public function anUnauthorizedUserCanGenerateSaleReport(): void
    {
        CategoryFactory::new()->create();
        ProductFactory::new()->create();
        ...
        $this->actingAs($user)->get(route('report.sales', ['extension' => 'xlsx']))
            ->assertStatus(403);
    }

    /**
     * test to verify if an authorized user can generate report of sale
     *
     * @test
     * @return void
     */
    public function anAuthorizedUserCanGenerateSaleReport(): void
    {
        ...
        $this->actingAs($user)->from(route('admin.order.index'))
            ->get(route('report.sales', ['extension' => 'xlsx']))
